...
<article>
  <section class="about-text">
    <header>
      <h2 class="h2 article-title">Pinboard</h2>
    </header>
      ...
      <ol class="timeline-list">
        <li class="timeline-item">
          ...
          <p class="timeline-text">
            This week the first
            <a target="_blank" href="https://ef-geometry.univie.ac.at/kick-off-workshop-a-new-geometry-for-einsteins-theory-of-relativity-and-beyond/"> Kick-off workshop</a> in the Emerging
            Fields project takes place.
          </p>
        </li>
        ...
        <li class="timeline-item">
          ...
          <h4 class="h4 timeline-item-title">A new geometry for Einstein's Theory of Relativity and Beyond</h4>
          <p class="timeline-text">
            The Austrian Science Fund (FWF) has announced to fund the project
            <a target="_blank" href="https://ef-geometry.univie.ac.at/">
              <b>A new geometry for Einstein's Theory of Relativity and Beyond</b>
            </a>
            in its new Emerging Fields excellency programme. The funding sum is an unprecedented 7 Million Euro. The project team consist of
            <a target="_blank" href="http://www.mat.univie.ac.at/~mike">Michael Kunzinger</a>
            ,
            <a target="_blank" href="https://sites.google.com/view/rperalesmathwebsite/home">Raquel Perales</a>
            ,
            <a target="_blank" href="https://sites.google.com/view/chiararigoni/home">Chiara Rigoni</a>
            ,
            <a target="_blank" href="https://clemenssaemann.wordpress.com/about/">Clemens Sämann</a>
            , and
            ...
            <a
              target="_blank"
              href="https://medienportal.univie.ac.at/media/aktuelle-pressemeldungen/detailansicht/artikel/emerging-fields-hochinnovative-forschungsvorhaben-mit-revolutionspotenzial/"
              >University of Vienna</a
            >
            and the
            <a
              target="_blank"
              href="https://mathematik.univie.ac.at/en/eventsnews/full-news-display/news/emerging-fields-hochinnovative-forschungsvorhaben-mit-revolutionspotenzial/?no_cache=1&cHash=4fffba8c70c66e016024600c723c82f2"
        ...
        <li class="timeline-item">
          ...
          <ul>
            <li class="list-dot">
              Sept: Our research group organized the <a target="_blank" href="https://mathematik.univie.ac.at/GF2022/ "> International Conference on Generalized Functions GF2022</a> at our
              Faculty in Vienna.
            </li>
            ...
            <li class="list-dot">
              April: I gave the invited main talk
              <a target="_blank" href="https://www.mat.univie.ac.at/~stein/research/talks/lft-22-webversion-printout.pdf"> Raumzeitsingularitäten: Die Theoreme von Penrose und Hawking </a>
              (Spacetime singularities: The theorems of Penrose and Hawking) at the
              <a target="blank" href="https://mathematikdidaktik.univie.ac.at/veranstaltungen/ostertagung-2022/"> ÖMG-Fortbildungstagung für Lehrhr&auml;fte </a>
              (Teacher Training Day of the Austrian Mathematical Society).
            </li>
          </ul>
        </li>
        ...
        <li class="timeline-item">
          ...
          <h4 class="h4 timeline-item-title">Solidarity with Ukraine</h4>
          <p class="timeline-text">The University of Vienna stands with Ukraine and condemns the attack on the country.</p>
        </li>

        <li class="timeline-item">
          <span>2021 Selected events</span>
          <ul>
            <li class="list-dot">
              Sept: The project application <i>Marginally outer trapped tubes</i> of <a target="_blank" href="https://ufind.univie.ac.at/de/person.html?id=5284">Walter Simon</a>, where I am a
              co-applicant was selected for funding by FWF.
            </li>
            <li class="list-dot">
              July: I have coorganized the small
              <a target="_blank" href="https://sites.google.com/site/professorsormani/home/conferences/2021-null-distance-wokshop"> 2021 Null Distance Workshop </a> with
              <a target="_bank" href="https://sites.google.com/site/professorsormani/home">Cristina Sormani</a>.
            </li>
            <li class="list-dot">
              June: I have coorganized the online-meeting
              <a target="_blank" href="https://sites.google.com/view/scri21/"> SCRI21: Singularity theorems, causality, and all that (A tribute to Roger Penrose) </a> with Piotr Chrusciel,
              Melanie Graf, Ettore Minguzzi, and Mike Kunzinger.
            </li>
            <li class="list-dot">
              March: The talks of the 10th International Meeting on Lorentzian Geometry <a target="_blank" href="http://www.uco.es/geometria/">GeLoCor</a> , where I was a member of the
              scientific commitee are now available on a <a target="_blank" href="https://www.youtube.com/channel/UCrSEpDE_tgfZ-dqUsJ5d9Tw/featured"> Youtube channel </a>
            </li>
            <li class="list-dot">
              Feb: My FWF-funded research project <b>Non-smooth spacetime geometry</b> has started with two Ph.D. students employed,
              <a target="_blank" href="https://ufind.univie.ac.at/de/person.html?id=114843">Matteo Calisti</a>
              and <a target="_blank" href="https://ufind.univie.ac.at/de/person.html?id=114757">Felix Rott</a>.
            </li>
          </ul>
        </li>

        <li class="timeline-item">
          <span>2020 Selected events</span>
          <ul>
            <li class="list-dot">My project application <i>Non-smooth spacetime geometry</i> was selected for funding by FWF.</li>
            <li class="list-dot">
              My Ph.D. student <a target="_blank" href="https://ufind.univie.ac.at/en/person.html?id=105258">Benedict Schinnerl</a> was awarded a
              <a target="_blank" href="https://medienportal.univie.ac.at/uniview/uni-intern/detailansicht/artikel/erfolgreiche-nachwuchswissenschafterinnen-21/"> Uni:Docs scholarship </a>.
            </li>
          </ul>
        </li>

        <li class="timeline-item">
          <span>2019 Selected events</span>
          <ul>
            <li class="list-dot">I gave a public lecture "Raumzeitsingularitäten" (spacetime singularities) at Plaentarium Wien.</li>
            <li class="list-dot">
              <a target="_blank" href="http://utf.mff.cuni.cz/~podolsky/">Jiri Podolsky</a>
              , a theoretical physicist from Charles University at Prague (and a frequent collaborator of mine) has written a background story on his research for
              <a target="_blank" href="https://cqgplus.com/">CQG+</a>. It is entiteled
              <a target="_blank" href="https://cqgplus.com/2018/08/20/understanding-exact-space-times/"> Understanding exact space-times </a>
              and also briefly describes our joint project(s).
            </li>
          </ul>
        </li>

        <li class="timeline-item">
          <span>2018: Textbook</span>
          <p class="timeline-text">
            The 3rd edition of our textbook with Hermann Schichl <i>Einführung in das mathematische Arbeiten</i> (German; Introduction into mathematical methodology) has appeared.
          </p>
        </li>
      </ol>
    </section>
